...
mod tests {
    ...
    fn gpu_forge_fold_line_soa_matches_handwritten() {
        ...
        // Single element to isolate exactly what FORGE computes vs the
        // hand-written kernel.  Inputs chosen to be small + canonical so
        // any divergence is purely a codegen bug, not canonicalization.
        let half_n: u32 = 512;
        let n: u32 = half_n * 2;
